<template>
  <div>
    <v-btn @click="addproduct" color="success">AddProduct</v-btn>
    <v-row>
      <v-col>
        <v-simple-table>
          <thead>
          ...
          <tbody>
            <tr v-for="(item, index) in products" :key="item.id">
              ...
              <td>
                <v-btn color="yellow" @click="edit(item.id)"> Edit</v-btn>
        ...
        <v-dialog v-model="dialogEdit" persistent max-width="600px">
          <v-card>
              ...
              <v-container>
                <v-row>
                  ...
                  <v-col cols="12">
                    <v-text-field
                      label="Description*"
                      v-model="descritionedit"
                      required
                    ></v-text-field>
                  </v-col>
                  <v-img :src="imageedit" width="200px" height="200px" >
            ...
            <v-card-actions>
              ...
              <v-btn color="blue darken-1" text @click="saveedit(idedit)"> Save </v-btn>
            </v-card-actions>
          </v-card>
        </v-dialog>
      </v-row>
  ...
  methods: {
    ...
    edit(id) {
      ...
      http.get(`productReadID/${id}`).then((response) => {
        ...
        this.descritionedit= response.data.descrition;
    ...
    saveedit(id){
        ...
        descrition: this.descritionedit,
